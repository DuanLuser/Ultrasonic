...
class Device(models.Model):
    ...
    device_name = models.CharField(verbose_name='监管区域', max_length=100, default='测试区域')#区域
    description = models.TextField(verbose_name='描述', blank=True)#名称
    ...
    angle = models.CharField(verbose_name='角度', max_length=35, default='', editable=False)
    distance = models.CharField(verbose_name='距离', max_length=35, default='', editable=False)
